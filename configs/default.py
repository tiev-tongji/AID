...
default_config = dict(
    ...
    algo_params=dict(
        ...
        num_ensemble=12, # number of ensemble models
        # IDAQ
        onlineadapt_max_num_candidates=5, # number of candidates for online adaptation
        r_thres=0.3, # threshold for online adaptation
        is_onlineadapt_max=False, # whether to use Prediction Error or Prediction Variance
        is_onlineadapt_thres=True, # whether to use Return-based
        FOCAL = dict(
            hvar_punish_w = 2,

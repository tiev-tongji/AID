"""
Visualize the trajectory at the final timestep in the Point-Robot environment:

1. In-distribution trajectory: `draw_path()`
2. Partial OOD context trajectory: `draw_OOD_task_path()`
3. OOD task trajectory: `draw_manual_task_path()`
4. Latent variable $z$ distribution: `draw_z()`
"""
import os
